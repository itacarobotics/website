...
:::warning
You must source the `ROS` and `ulixarm_ros2` workspace in **every new terminal** before running any ROS 2 commands. If you completed the [Getting Started](../getting-started#source-the-environment) guide, this is already handled automatically via your `.bashrc`.
:::
